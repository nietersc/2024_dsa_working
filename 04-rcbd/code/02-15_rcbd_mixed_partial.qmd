...
1) Compare between fixed effect block model and the random effect block model: 
  a) ANOVA table p values
  b) emmeans standard error values
  c) Compare letter separation (cld)
  
Email answers to lmbastos@uga.edu
